import{_ as s,o as n,c as a,U as p}from"./chunks/framework.9adb0f96.js";const y=JSON.parse('{"title":"记录微信小程序打开多个文档问题的解决","description":"","frontmatter":{"layout":"blog","title":"记录微信小程序打开多个文档问题的解决","date":"2022-08-09T02:37:26.309Z"},"headers":[],"relativePath":"mini-apps/记录微信小程序打开多个文档问题的解决.md","filePath":"mini-apps/记录微信小程序打开多个文档问题的解决.md","lastUpdated":1676532347000}'),l={name:"mini-apps/记录微信小程序打开多个文档问题的解决.md"},e=p(`<p>小程序无法打开文件夹，可是有时候需要预览多个pdf文件。</p><p>一开始，我的思路是在for循环中使用openDocument Api打开多个文档。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">for (let index in that.data.files) {</span></span>
